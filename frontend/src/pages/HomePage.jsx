...
export default function HomePage() {
  return (
    <div>
      ...
      <div 
      id="about"
      className="bg-navy h-screen py-24 px-24">
        <h1 className="text-7xl font-bold font-iskoola text-white mb-6 ">ගුරුවරයා පිළිබඳව...</h1>
        <p className="text-white font-iskoola text-xl leading-relaxed px-36">
          ...
          රසායන විද්‍යාව යනු සූත්‍ර සහ සමීකරණ පමණක් නොව, අප අවට ලෝකය ක්‍රියාත්මක වන ආකාරය තේරුම් ගැනීමට උපකාරී වන විෂයයක් බව මම විශ්වාස කරමි. ඒ නිසාම සෑම පාඩමක්ම සැබෑ ජීවිත උදාහරණ සහ ක්‍රියාකාරකම් සමඟ ඉදිරිපත් කරමින්, සිසුන් තුළ විෂය පිළිබඳ උනන්දුව සහ විශ්වාසය ගොඩනැගීමට උත්සාහ කරමි.
        </p>
        <p className="text-white font-iskoola text-xl leading-relaxed px-36 mt-2">
        ...
        <div className="flex items-center justify-center gap-6 ">
          <h1 className="text-[100px]  font-mahee text-white mb-6 mt-12">wms</h1> <span className="text-[100px] font-sansala text-yelo"> rcqka</span><span className="text-[100px] font-mahee text-white">;kkafkuq'</span>
        </div>
      </div>
      {/*Classes Section */}
      <div 
      id="classes"
      className="bg-white h-screen py-24 px-24 flex flex-col items-center">
        <div>
          <h1 className="text-7xl font-bold font-iskoola text-navy mb-6 ">අපගේ පාඨමාලාවන්</h1>
        </div>
        <div className="grid grid-cols-3 gap-6 mt-12">
          <div className="bg-navy rounded-lg p-6 flex flex-col items-center">
            <h2 className="text-3xl font-bold text-white mb-10">Revison Classes</h2>
            <p className="text-white font-iskoola text-lg text-center">
              මීට පෙර ඉගෙන ගත් සියලුම විෂය කරුණු නැවත සමාලෝචනය කරමින්, ඔබට අමතක වී ඇති හෝ නොතේරුණු කරුණු නැවත පැහැදිලි කිරීම. හොඳම අවස්ථාවයි. මෙම පන්තිවල දී වැදගත්ම කරුණු ඉස්මතු කරමින්, විභාගයට වඩාත් ප්‍රයෝජනවත් වන ආකාරයෙන් නැවත පැහැදිලි කරනු ලැබේ. ඔබේ දැනුම තහවුරු කර ගැනීමට සහ විභාග සූදානමේ දී ආත්මවිශ්වාසය ගොඩ නගා ගැනීමට <span>Revison Classes</span> වලට සහභාගී වීම ඉතාමත් වැදගත් වේ.
            </p>
          </div>
          <div className="bg-navy rounded-lg p-6 flex flex-col items-center">
            <h2 className="text-3xl font-bold  text-white mb-10">Theory Classes</h2>
            <p className="text-white font-iskoola text-lg text-center">
          ...
          <div className="bg-navy rounded-lg p-6 flex flex-col items-center">
            <h2 className="text-3xl font-bold  text-white mb-10">Paper Classes</h2>
            <p className="text-white font-iskoola text-lg text-center">
              විභාගයට සෘජුවම සූදානම් වීම සඳහා වැදගත්ම පන්ති වර්ගය වේ. අපගේ පන්තිවල දී ගතවූ වර්ෂවල විභාග ප්‍රශ්න පත්‍ර විශ්ලේෂණය කරමින්, ප්‍රශ්නවලට නිවැරදිව සහ වේගයෙන් පිළිතුරු සැපයීමේ ක්‍රමවේද ඉගෙන ගනු ලැබේ. කාල කළමනාකරණය, ලකුණු ලබා ගැනීමේ උපක්‍රම සහ පොදු වැරදි මඟහරවා ගන්නා ආකාරය පිළිබඳව අප විසින් විශේෂ මඟ පෙන්වීමක් ලබා දෙනු ඇත. දිගු කලක් <span>Theory</span> ඉගෙන ගත් දැනුම ප්‍රායෝගිකව යොදා ගැනීමට සහ විභාගයේදී උපරිම ලකුණු ලබා ගැනීමට අපි මග පෙන්වන්නෙමු.
            </p>
          </div>
        </div>
      </div>
      ...
      <div 
        id="process"
        className="py-24 px-24 flex flex-col items-center">
        <div>
          <h1 className="text-7xl font-bold font-iskoola text-navy mb-6">අපගේ වැඩපිළිවෙල</h1>
        </div>
        <div className="grid grid-cols-2 gap-6 mt-12">

          {/* A to Z Theory */}
          <div className="bg-white border border-gra rounded-lg p-6 flex flex-col items-center">
            <h2 className="text-3xl font-bold text-navy mb-10">A to Z Theory</h2>
            <div className="flex">
              <img
                src={theory}
                alt="Theory"
                className="w-1/2 h-48 object-cover rounded-lg mr-4"
              />
              <p className="text-navy font-iskoola text-lg text-center">
          ...
          {/* Short Note */}
          <div className="bg-white border border-gra rounded-lg p-6 flex flex-col items-center">
            <h2 className="text-3xl font-bold text-navy mb-10">Short Note</h2>
            <div className="flex">
              <img
                src={shortNote}
                alt="Short Note"
          ...
          {/* Daily Reminders */}
          <div className="bg-white border border-gra rounded-lg p-6 flex flex-col items-center">
            <h2 className="text-3xl font-bold text-navy mb-10">Daily Reminders</h2>
            <div className="flex">
              <img
                src={dailyReminders}
                alt="Daily Reminders"
          ...
          <div className="bg-white border border-gra rounded-lg p-6 flex flex-col items-center">
            <h2 className="text-3xl font-bold text-navy mb-10">Challenging Test Paper</h2>
            <div className="flex">
              <img
